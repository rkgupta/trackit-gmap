...
public class OrderPageEx  implements java.io.Serializable {
    private java.lang.Integer numberOfOrders;

    private java.lang.Integer numberOfPages;

    private com.poc.clearpath.domain.OrderHeaderEx[] orders;
    ...
    public OrderPageEx(
           ...
           com.poc.clearpath.domain.OrderHeaderEx[] orders) {
    ...
    /**
     * Gets the numberOfOrders value for this OrderPageEx.
     * 
    ...
    /**
     * Sets the numberOfOrders value for this OrderPageEx.
     * 
    ...
    /**
     * Gets the numberOfPages value for this OrderPageEx.
     * 
    ...
    /**
     * Sets the numberOfPages value for this OrderPageEx.
     * 
     * @param numberOfPages
     */
    ...
    /**
     * Gets the orders value for this OrderPageEx.
     * 
     * @return orders
     */
    public com.poc.clearpath.domain.OrderHeaderEx[] getOrders() {
        return orders;
    }


    /**
     * Sets the orders value for this OrderPageEx.
     * 
     * @param orders
     */
    public void setOrders(com.poc.clearpath.domain.OrderHeaderEx[] orders) {
        this.orders = orders;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OrderPageEx)) return false;
        OrderPageEx other = (OrderPageEx) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OrderPageEx.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:v9_0.domain.pbclearpath.com", "OrderPageEx"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:v9_0.domain.pbclearpath.com", "OrderHeaderEx"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
